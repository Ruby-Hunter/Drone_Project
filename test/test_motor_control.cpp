...
void test_balancePitch(){
    ...
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE + 1, getSpeed(1));
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE + 1, getSpeed(2));
    ...
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE + 1, getSpeed(1));
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE + 1, getSpeed(2));
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE/2 + 1, getSpeed(3));
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE/2 + 1, getSpeed(4));
}
...
void test_balanceRoll(){
    ...
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE + 1, getSpeed(2));
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE + 1, getSpeed(3));
    ...
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE + 1, getSpeed(2));
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE + 1, getSpeed(3));
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE/2 + 1, getSpeed(1));
    TEST_ASSERT_EQUAL(START_SPEED + MAX_PWM_CHANGE/2 + 1, getSpeed(4));
}